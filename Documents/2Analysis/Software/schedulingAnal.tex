\section{Scheduling} \label{analysis:scheduling}% \todo{Where does this section come from? It's out of place since nothing in this entire chapter has anything to do with scheduling. Should it be moved to the theory chapter?}

%Short, what is scheduling and why do we need it? Why do ordinary software projects not need scheduling?

In this section there will be a brief explanation of what scheduling are used for, a small discussion about what scheduling method would be best suited for this project.\unsure{seems like this should come before we choice nxtOSEK}\unsure{i would like to use some of the terms i explained in the theory section}
