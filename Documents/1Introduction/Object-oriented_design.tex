...
The following list briefly explains the functionality mentioned and their associated use cases:\unsure{"This Functionality bliver brugt hele vejen ned, slet ved alle?}
\begin{itemize}
...
For this functionality, the bus has to maintain a speed under a specified threshold. Used in use case 9.\todo{Same as speed controller??}
