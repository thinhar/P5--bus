...
\begin{description}
    \item [(1) Follow Track]
    The bus should be able to detect the lines, marking the edges of the lane and stay within these. The relation between the size of the track and the LEGO bus should be the same as the relation real busses have with real roads in Denmark. This also applies to the turning degrees of any road turns. \todo{Første gang læseren hører om dette, mangler et afsnit eller noget, som gav os denne design beslutning}
